...
public class j1login extends javax.swing.JFrame {
    Connection con =null;
    PreparedStatement pst =null;
    ResultSet rs =null;

    public j1login() throws ClassNotFoundException {
        setLocation(400,200);
        setResizable(false);
        initComponents();
    ...
    public void login()
    {
        String sql = "SELECT * FROM login WHERE tk=? and mk=?";
        try
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(j1login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new j1login().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(j1login.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
